      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex flex-col">
              ...
              {items.map((item) => (
               ...
               <input
                ...
                onChange={(e) => {
                  ...
                  if (value === '') {
                    // allow empty input but do not remove item
        ...
        {items.length > 0 && (
          ...
          <div className="border-t p-4 bg-gray-50">
            ...
            {/* Note Message */}
            <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm rounded-lg p-2 mb-3">
              ⚠️ Note: Products are <strong>not returnable</strong>
            </div>
            <div className="bg-blue-50 border border-blue-200 text-blue-800 text-sm rounded-lg p-1 mb-4 ">
            🚚 Courier charges extra (based on location).
            </div>
            <button
              onClick={onCheckout}
